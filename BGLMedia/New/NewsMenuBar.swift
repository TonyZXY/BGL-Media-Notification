...
class NewsMenuBar:UIView,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout{
    var color = ThemeColor()
    
    var menuitems:[String]{
        get{
            return [textValue(name:"navigationTitle_flash"),textValue(name:"news_newsPage")]
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        newsViewController?.scrollToMenuIndex(menuIndex: indexPath.row)
    }
...
class NewsMenuCell: UICollectionViewCell{
    var color = ThemeColor()
