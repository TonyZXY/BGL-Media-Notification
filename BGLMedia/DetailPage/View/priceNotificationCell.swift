...
class priceNotificationCell:UITableViewCell,UITextFieldDelegate{
    ...
    func setUpView(){
        priceTypeLabel.font = UIFont.regularFont(14*factor!)
        priceTextField.font = UIFont.regularFont(14*factor!)
        dateLabel.font = UIFont.regularFont(17*factor!)
        coinDetailLabel.font = UIFont.regularFont(17*factor!)
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:[v1]-\(30*factor!)-[v0(\(50*factor!))]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":priceTypeLabel,"v1":priceTextField]))
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[v0(\(40*factor!))]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":priceTypeLabel,"v1":priceTextField]))
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[v1(\(40*factor!))]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":priceTypeLabel,"v1":priceTextField]))
        
        
        NSLayoutConstraint(item: priceTypeLabel, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing, multiplier: 1, constant: -10*factor!).isActive = true
        ...
        NSLayoutConstraint(item: priceTextField, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: 10*factor!).isActive = true
