...
class languageCell:UITableViewCell{
    ...
    func setupviews(){
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-\(10*factor!)-[v0(\(50*factor!))]-\(10*factor!)-[v1]-\(10*factor!)-|", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":logoView,"v1":languageLabel]))
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[v0(\(50*factor!))]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":logoView,"v1":languageLabel]))
    }
}
