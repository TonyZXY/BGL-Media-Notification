...
//        let dateFormat1 = "yyyy-MM-dd"
    ...
    func convertTimeToStringPickerDate2(date: Date) -> String {
        let dateFormatter = DateFormatter()
        let dateFormat2 = "HH:mm"
        dateFormatter.dateFormat = dateFormat2
        let newDate: String = dateFormatter.string(from: date)
        return newDate
    }
...
extension UIColor{
    class func addColor(_ color1: UIColor, with color2: UIColor) -> UIColor {
    ...
    class func multiplyColor(_ color: UIColor, by multiplier: CGFloat) -> UIColor {
