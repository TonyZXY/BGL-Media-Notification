...
class CustomAlertController: UIViewController {
    ...
    func setUpView(){
        ...
        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-30-[v0]-30-|", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":alertView]))
        ...
        alertView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:[v0(60)]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":logo]))
        alertView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[v0(60)]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":logo]))
        alertView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:[v0(80)]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":logoImage]))
        alertView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:[v0(80)]", options: NSLayoutFormatOptions(), metrics: nil, views: ["v0":logoImage]))
...
//        NSLayoutConstraint(item: descriptionLabel, attribute: .bottom, relatedBy: .equal, toItem: sendEmailButton, attribute: .top, multiplier: 1, constant:-5).isActive = true
    ...
    var sendEmailButton:UIButton = {
        ...
        button.setTitle("Send Verify Email", for: .normal)
